...
public class PlayerCharacter : MonoBehaviour {
	...
	private TPSPlayer FPSPlayerComponent;
	...
	void Start () {
        ...
        if (PlayerPrefs.GetString("Mode") == "multi")
        {
            fpBodyObj = Instantiate(myTransform.GetChild(0).gameObject, myTransform.GetChild(0).position, myTransform.GetChild(0).rotation) as GameObject;
        }
        else
        {
        ...
        //    fpBodyAnim.GetBoneTransform(HumanBodyBones.Head).localScale =new Vector3(0.000001f, 0.000001f, 0.000001f);
        //    fpBodyAnim.GetBoneTransform(HumanBodyBones.RightUpperArm).localScale = new Vector3(0.000001f, 0.000001f, 0.000001f);
        //    fpBodyAnim.GetBoneTransform(HumanBodyBones.LeftUpperArm).localScale = new Vector3(0.000001f, 0.000001f, 0.000001f);
        //}else{
        //    Debug.Log("<color=red>Player model avatar error:</color> Please check your player character setup and animator avatar reference.");
        //}
	...
	void Update () {
		...
		if(anim.isInitialized && fpBodyAnim.isInitialized && Time.timeScale > 0.0f){
            ...
            fpBodyTransform.localScale = Vector3.zero;
